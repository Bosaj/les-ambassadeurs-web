        ...
        >
            <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden text-center">
                <div className="bg-blue-900 p-8 text-white relative overflow-hidden">
                    ...
                    <h1 className="text-3xl font-bold relative z-10">{t.volunteer_title || "Join as Volunteer"}</h1>
                    <p className="text-blue-200 mt-2 relative z-10">
                        {t.volunteer_subtitle || "Start your journey with us today."}
                    </p>
                </div>

                <div className="p-8">
                    <p className="text-gray-600 dark:text-gray-300 mb-8">
                        {t.volunteer_signin_desc || "Join our community of changemakers. Sign in with Google to create your volunteer account instantly."}
                    </p>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700">
                        <p className="text-xs text-gray-400">
                            {t.volunteer_terms || "By joining, you agree to our Terms of Service and Privacy Policy. You will be assigned the Volunteer role by default."}
                        </p>
                    </div>
                </div>
            </div>
